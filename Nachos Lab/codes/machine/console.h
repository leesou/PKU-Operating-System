...
class SynchConsole
{
  public:
    ...
    void SynchPutChar(char ch); // wrap PutChar with lock & semaphore
    char SynchGetChar(); // wrap GetChar with lock & semaphore

    void WriteDone(); // writeHandler for console
    void ReadAvail(); // readHandler for console
