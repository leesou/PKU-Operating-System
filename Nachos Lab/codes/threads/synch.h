...
//----------------------------------------------------------------------
// Barrier
// 	Barrier provides a thread-coordination mechanism 
//  that allows a set of participating threads to block 
...
class Barrier
{
  ...
  private:
    ...
    int num_left;                   // number of threads havn't reached
